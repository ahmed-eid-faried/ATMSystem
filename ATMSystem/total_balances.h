...
void ReadFileByVectorTotalBalances(vector<string>& vFile, string AccountNumber, double& TotalBalances) {
	TotalBalances = 0;
...
void TotalBalances() {
	...
	ReadFileByVectorTotalBalances(vFile, AccountNumber, TotalBalances);
